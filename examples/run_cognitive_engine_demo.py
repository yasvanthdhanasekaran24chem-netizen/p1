...
def toy_simulator(params):
    # Placeholder for real engineering simulation
    x = params["x"]
    y = params["y"]
...
engine = CognitiveEngine(
    domain="toy_process",
    planner=ModelBasedPlanner(random_candidates=80, beta=0.5, acquisition="ei"),
    memory=CognitiveMemoryStore(path=os.path.join(PROJECT_ROOT, "cognitive_memory.jsonl")),
